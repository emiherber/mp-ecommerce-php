<?php require_once __DIR__ . '/includes/MercadoPago/MercadoPago.php'; ?>
                                        ...
                                        <?php
                                            try {
                                                ...
                                                $itemCompra = $mercadoPago->crearItemPreferencia(
                                                    ...
                                                    utf8_encode('Dispositivo móvil de Tienda e-commerce​')
                                                    , 
                                                    substr($_POST['img'], 1),
                                                );
                                                ...
                                                echo '<div class="alert alert-error alert-dismissible fade show" role="alert"> '
                                                    ...
                                                    . '<strong>Problemas Con Mercado Pago!</strong> '.$ex->getMessage().'</div>';
                                            }
                                        ?>
